		...
		<div id="outer">
			...
			<div id="loginForm">
				<form action="#" method="POST">
					<input type="text" name="username" id="loginName" placeholder="请输入用户名" ><br>
					...
					<input type="button" value="登录" class="submit" onclick="loginConfirm()">
				</form>
			</div>
			<div id="registerForm">
				<form action="#" method="POST">
					<input type="text" name="username" id="registerName" placeholder="请输入用户名"><br>
					...
					<input type="button" value="注册" class="submit" onclick="registerConfirm()">
				</form>
			</div>
